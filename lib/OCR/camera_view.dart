...
import 'package:denemeler_1/main.dart';
...
class _CameraViewState extends State<CameraView> {
  ...
  Future<void> processImage(InputImage inputImage) async {
    ...
    for (int i = 0; i < recognisedText.blocks.length; i++) {
      ...
      getModel.recognizedTexts.add(recognisedText.blocks[i].text);
    getModel.yorumController.text = getModel.yorumController.text + recognisedText.blocks[i].text;
    }
  ...
  Future _getImage(ImageSource source) async {
    ...
    await _imagePicker?.pickImage(source: source).then((value) {
      pickedFile = value;
      if (pickedFile != null) {
        _processPickedFile(pickedFile).then((value) {
